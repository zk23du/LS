...
from flcore.servers.serverscaff import SCAFF
from flcore.servers.serverpgd import FedPGD
from flcore.servers.serverdinsgd import FedDinsgd
from flcore.servers.serverarmijo import FedArmijo
from flcore.servers.serveradam import FedAdam
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if args.algorithm == "FedAvg":
            server = FedAvg(args,i,args.model)
